public class MenuTestDrive {
    public static void main(String[] args) {
        ...
        pancakeHouseMenu.add(new MenuItem("블루베리 팬케이크", "신선한 블루베리 시럽으로 만든 팬케이크", true, 3.49));
        ...
        dessertMenu.add(new MenuItem("애플 파이", "바삭한 크러스트에 바닐라 아이스크림이 얹혀 있는 애플 파이", true, 1.59));
        dessertMenu.add(new MenuItem("치즈 케이크", "초콜릿 그레이엄 크러스트 위에 부드러운 뉴욕 치즈 케이크", true, 1.99));
